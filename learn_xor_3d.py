...
xy_train = np.array([[0,0],[0,1],[1,0],[1,1]])

z_train  = np.array([ [0],  [1],  [1],  [0] ])
...
def draw_graph() :    
    ...
    axis.plot_surface(x_mesh, y_mesh, z_mesh, cmap="rainbow")
